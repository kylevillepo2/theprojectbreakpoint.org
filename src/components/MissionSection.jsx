    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full py-12">
        <div className="flex justify-center items-center w-full">
          {/* Mission Content */}
          <div className="text-white space-y-8 px-8 lg:px-16 max-w-5xl">
            {/* Mission Text */}
            <div className="space-y-6 drop-shadow-lg md:drop-shadow-xl">
              <h2 className="text-5xl md:text-6xl font-extrabold leading-tight">
                Our Mission
              </h2>
              <p className="text-2xl md:text-3xl leading-relaxed text-gray-100">
            ...
            <div className="grid grid-cols-2 gap-8 pt-6">
              <div className="text-center p-8 bg-white/15 rounded-lg backdrop-blur-sm">
                <div className="text-5xl font-extrabold text-accent mb-2">200+</div>
                <div className="text-xl text-white font-semibold">Youth Served</div>
              </div>
              <div className="text-center p-8 bg-white/15 rounded-lg backdrop-blur-sm">
                <div className="text-5xl font-extrabold text-accent mb-2">100%</div>
                <div className="text-xl text-white font-semibold">Free Programs</div>
              </div>
            </div>
